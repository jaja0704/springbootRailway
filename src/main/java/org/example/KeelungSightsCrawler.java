...
public class KeelungSightsCrawler {
    ...
    public Sight[] getItems(String string) {
        ...
        try {
            String htmlPage = Jsoup.connect("https://jaja0704.github.io/www.travelking.com.tw/tourguide/taiwan/keelungcity/index.html")
                ...
                .timeout(5000)
                .get().toString();
            Document doc = Jsoup.parse(htmlPage, "https://jaja0704.github.io/www.travelking.com.tw/tourguide/taiwan/keelungcity/index.html");
